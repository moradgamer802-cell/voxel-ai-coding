...
```
Serve it locally for testing: `zyvo preview` (starts a server and opens the browser).

## Rules
- **Test on the real phone** — emulator is not available on Termux; use `zyvo preview`
...
## Deliver
- The project folder + how to open/test it (`zyvo preview`)
